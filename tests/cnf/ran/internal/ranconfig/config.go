...
type HubConfig struct {
	...
	// O2IMSClientCertSecret is the name of the secret in the oran-o2ims namespace that contains the client
	// certificate to use when interacting with the O2IMS and OAuth APIs.
	//
