...
// and token. It first finds the address of the Alertmanager route, creates a ServiceAccount and ClusterRoleBinding to
// access the API, and then creates the Alertmanager API client using the address and a token generated for the
// ServiceAccount.
