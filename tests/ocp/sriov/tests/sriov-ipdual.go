...
var _ = Describe("SR-IOV DualStack", Ordered, Label(tsparams.LabelSriovIPvDual), ContinueOnFailure, func() {
	const (
	...
	BeforeAll(func() {
		...
		if !sriovocpenv.ClusterSupportsDualStack(clusterIPFamily) {
