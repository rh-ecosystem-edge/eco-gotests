...
- `ECO_ASSISTED_ZTP_SPOKE_INFRAENV_NAME`: Optional InfraEnv name override. When unset, classic CIM naming (`name == cluster`) is tried first, then any InfraEnv in the spoke namespace (SiteConfig per-node InfraEnvs)
