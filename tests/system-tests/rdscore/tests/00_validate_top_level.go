	...
	Label("rds-core-workflow"), func() {
		Context("Configured Cluster", Label("clean-cluster"), func() {
			...
			It("Verifies jumbo frame support on secondary SR-IOV kernel-mode interfaces",
				Label("sriov", "sriov-jumbo-frame"), reportxml.ID("95010"),
			...
			DescribeTable("Verifies ClusterImagePolicy signature validation",
				...
				Entry("Signed mirrored publicKey image passes validation",
					Label("crio-image-signature", "crio-image-signature-publickey",
						"crio-image-signature-mirrored", "crio-image-signature-positive"),
					reportxml.ID("90579"), SpecTimeout(10*time.Minute), "publickey-mirrored-signed"),
				Entry("Not signed mirrored publicKey image fails validation",
					Label("crio-image-signature", "crio-image-signature-publickey",
						"crio-image-signature-mirrored", "crio-image-signature-negative"),
					reportxml.ID("90580"), SpecTimeout(8*time.Minute), "publickey-mirrored-unsigned"),
				...
				Entry("Signed Certificate mirrored image passes validation",
					Label("crio-image-signature", "crio-image-signature-certificate",
						"crio-image-signature-mirrored", "crio-image-signature-positive"),
					reportxml.ID("90581"), SpecTimeout(10*time.Minute), "certificate-mirrored-signed"),
				Entry("Not signed Certificate mirrored image fails validation",
					Label("crio-image-signature", "crio-image-signature-certificate",
						"crio-image-signature-mirrored", "crio-image-signature-negative"),
					reportxml.ID("90582"), SpecTimeout(8*time.Minute), "certificate-mirrored-unsigned"),
